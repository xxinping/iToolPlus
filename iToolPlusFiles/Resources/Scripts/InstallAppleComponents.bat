...
start /B /WAIT "%SystemRoot%\System32\msiexec.exe" /i "%temp%\AppleApplicationSupport.msi" /quiet /qn
start /B /WAIT "%SystemRoot%\System32\msiexec.exe" /i "%temp%\Bonjour.msi" /quiet /qn
start /B /WAIT "%SystemRoot%\System32\msiexec.exe" /i "%temp%\AppleMobileDeviceSupport.msi" /quiet /qn